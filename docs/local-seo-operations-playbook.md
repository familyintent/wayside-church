...
- Keep `/llms.txt` generated from site settings and the YouTube feed so AI tools see current service times, contact details, public leadership facts, official pages, machine-readable resources, and recent teaching pages.
