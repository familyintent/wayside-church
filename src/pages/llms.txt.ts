...
export const GET: APIRoute = async () => {
  ...
  const keyPages: LinkItem[] = [
    ...
    { label: "Privacy Policy and SMS Terms", href: "/privacy-policy/" },
  ...
  const body = [
    ...
    "## Text Messaging",
    "",
    `- Program: ${site.privacyPolicy.sms.programName}`,
    `- Public opt-in page: ${absoluteUrl("/text-updates/", site.meta.siteUrl)}`,
    `- Verbal and written consent proof: ${absoluteUrl("/sms-consent-methods/", site.meta.siteUrl)}`,
    `- Written consent form: ${absoluteUrl("/sms-written-consent/", site.meta.siteUrl)}`,
    `- Verified messaging number: ${site.privacyPolicy.sms.smsNumberDisplay}`,
    `- Opt in or resume: reply ${site.privacyPolicy.sms.optInKeyword}`,
    `- Opt out: reply ${site.privacyPolicy.sms.optOutKeyword}`,
    `- Help: reply ${site.privacyPolicy.sms.helpKeyword} or call ${site.contact.phone}`,
    `- ${site.privacyPolicy.sms.messageFrequency}`,
    "- Message and data rates may apply.",
    `- Privacy Policy and SMS Terms: ${absoluteUrl("/privacy-policy/", site.meta.siteUrl)}`,
    `- Terms & Conditions: ${absoluteUrl("/terms-and-conditions/", site.meta.siteUrl)}`,
    "",
    "## Official Profiles",
    "",
    ...officialProfiles,
