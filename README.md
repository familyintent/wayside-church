...
- generated `llms.txt` for AI discovery summaries, current visitor facts, public leadership facts, machine-readable resources, and recent teaching links
...
- `llms.txt` generated from the editable church settings and YouTube feed so AI-facing facts, public leadership facts, and recent teaching links stay aligned with the website
...
It pulls church facts and public leadership facts from `src/content/settings.yaml` and recent teaching links from the YouTube feed, so it should not be manually edited in `public/`.
